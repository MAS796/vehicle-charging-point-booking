...
export default function Insights() {
  ...
  return (
    <>
      <Seo
        title="EV Market Insights & Analytics | Industry Analysis"
        description="Explore comprehensive EV market trends, adoption rates, global charging station statistics, and industry forecasts."
      />
